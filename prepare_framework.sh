...
python3 opencv_objs.py "$BUILD_DIR/Release-iphonesimulator/lib$FRAMEWORK_NAME.a" && \
echo "✅ OpenCV libraries merged into $BUILD_DIR/Release-iphonesimulator/lib$FRAMEWORK_NAME.a."
...
python3 opencv_objs.py "$BUILD_DIR/Release-iphoneos/lib$FRAMEWORK_NAME.a" && \
echo "✅ OpenCV libraries merged into $BUILD_DIR/Release-iphoneos/lib$FRAMEWORK_NAME.a."
